...
def create_credentials_by_user(username: str, password: str, domain: str = None) -> CredentialsByUser:
    """
...
def create_credentials_in_server(username: str, 
                               password: str, 
                               domain: str = None, 
                               windows_credentials: bool = True) -> CredentialsInServer:
    """
